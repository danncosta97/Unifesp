...
<html>
  ...
  <body>
    ...
    <h1 style="text-align:center; font-family: Franklin Gothic Medium;">Cadastro realizado com sucesso. Redirecionando para suas tarefas...</h1>
    <script type="text/javascript">
      window.onload = function(){
        var link_to_home = "window.location='home.php?idusers=<?php echo $idusers; ?>'";
        setTimeout(link_to_home,2000);
      }
    </script>
