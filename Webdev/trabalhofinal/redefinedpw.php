...
<html>
  ...
  <body>
    ...
    <h1 style="text-align:center; font-family: Franklin Gothic Medium;">Senha alterada com sucesso! Redirecionando para Log In ...</h1>
    <script type="text/javascript">
      window.onload = function(){
        var link_to_home = "window.location='login.php'";
