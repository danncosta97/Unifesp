...
<html>
  <head>
    ...
    <title>Tarefas de <?php echo $usersfirst_name. ' '. $userslast_name; ?></title>
    <meta charset="utf-8">
    <style>
  ...
  <body>
    ...
    <h1 style="text-align:center"><?php echo $greetings ?></h1>
  ...
  <script type="text/javascript">
    function generate(){
      ...
      for(let i = 0; i < buttonsToGenerate; i++){
        if(desc_size = jArray[2+5*i].length>0){
